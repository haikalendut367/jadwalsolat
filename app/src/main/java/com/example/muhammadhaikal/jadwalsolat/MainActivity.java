package com.example.muhammadhaikal.jadwalsolat;
...
import com.example.muhammadhaikal.jadwalsolat.api.ApiService;
import com.example.muhammadhaikal.jadwalsolat.api.ApiUrl;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_dhuhr_value = findViewById(R.id.tv_dzuhur_value);
        tv_asr_value = findViewById(R.id.tv_ashar_value);
        tv_maghrib_value = findViewById(R.id.tv_maghrib_value);
        tv_isha_value = findViewById(R.id.tv_isya_value);
